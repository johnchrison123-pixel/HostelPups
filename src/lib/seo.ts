...
export function organizationSchema() {
  return {
    ...
    name: SITE.name,
    url: SITE.url,
    // /icon is auto-generated by src/app/icon.tsx via Next.js's convention.
    // Returns a 256x256 PNG with the HP monogram — good enough for Google
    // knowledge-panel / rich result logo until a final brand logo lands.
    logo: `${SITE.url}/icon`,
    sameAs: [
